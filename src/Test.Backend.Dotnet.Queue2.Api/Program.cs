...
using Test.Backend.Dotnet.Queue2.Api.Config;
using Test.Backend.Dotnet.Queue2.Api.Extensions;
using Test.Backend.Dotnet.Queue2.Api.HealthChecks;
...
namespace Test.Backend.Dotnet.Queue2.Api;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Test.Backend.Dotnet.Queue2", Version = "v1" });
        });
